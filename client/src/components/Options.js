          ...
          <form className={classes.root} noValidate autoComplete='off'>
            ...
            <Grid item xs={12} md={6} className={classes.padding}>
              ...
              {callAccepted && !callEnded ? (
                <Button varient='contained' color='secondary' startIcon={<PhoneDisabled fontSize='large'/>} fullWidth onClick={leaveCall} className={classes.margin} >
                  Hang Up
                </Button>
              ) : (
                  <Button varient='contained' color='Primary' startIcon={<Phone fontSize='large'/>} fullWidth onClick={()=> callUser(idToCall)}  className={classes.margin} >
                    Call
                  </Button>
              )}
